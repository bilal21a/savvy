...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="light" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    <head>
        <meta charset="utf-8" />
        <title>Reset Password | Savvy - Admin & Dashboard Template</title>
                                        ...
                                        <div class="row g-0">
                                            <div class="col-lg-6 offset-lg-3 card">
                                                <div class="p-lg-5 p-4">
                                                    ...
                                                    <div class="mt-4">
                                                        <form action="{{url('add-new-password-on-forget-request')}}" class="auth-input" method="post">
                                                            @csrf
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="new_password_confirmation" class="form-label">Retype Password</label>
                                                                <input type="text" class="form-control" name="new_password_confirmation" id="new_password_confirmation" placeholder="Retype Password">
                                                            </div>
