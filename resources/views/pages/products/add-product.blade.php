    ...
    <div class="row">
        <div class="col-md-12">
            <div class="d-flex align-items-start gap-3 mb-3">
                <button type="submit" class="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="pills-info-desc-tab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Add Product</button>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                    ...
                    <div class="row gy-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="sub_category_id" class="form-select">
                                    @foreach ($sub_categories as $category)
                                        <option {{(old("sub_category_id")==$category->id)?"selected":""}} value="{{$category->id}}">{{$category->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="amount" value="{{old("amount")}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="basiInput" class="form-label">Discount</label>
                                <input type="text" class="form-control" name="discount" value="{{old("discount")}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
